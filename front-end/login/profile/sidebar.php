<div class="d-flex flex-column flex-shrink-0 p-3 bg-light myDIV" style="width: 25%;">
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="overview.php" class="nav-link sideBarButton" aria-current="page">
        ...
        <li>
            <a href="orders.php" class="nav-link sideBarButton">
                ...
                Laatste reserveringen
            </a>
        </li>
        <li>
            <a href="profile.php" class="nav-link sideBarButton">
        ...
        <li>
            <a href="../../../includes/login/logout.inc.php" class="nav-link sideBarButton">
