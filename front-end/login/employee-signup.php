...
if ($_SESSION['userlevel'] !== 5 || !isset($_SESSION['userid'])) {
...
<div class="bg-light rounded-3 py-5 px-4 px-md-5 " style="height: 100vh;">
    ...
    <div class="row gx-5 justify-content-center">
        <div class="col-lg-8 col-xl-6">
            <form action="../../includes/login/employee-signup-request.inc.php" autocomplete="off" method="post">
                <!-- Signup Form-->
                ...
                <div class="d-grid mb-3"><button class="btn btnLogin btn-lg" name="submit-employee-signup" type="submit">Maak account</button></div>
